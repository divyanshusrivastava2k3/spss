  ...
  const cards = [
    {
      ...
      href: "/manage/dashboard/partners",
    },
    {
      ...
      href: "/manage/dashboard/programs",
    },
    {
    ...
    },
    {
      ...
      href: "/manage/dashboard/team",
    },
  ];

  const quickActions = [
    { titleKey: "admin.dashboard.actions.addPartner", href: "/manage/dashboard/partners", icon: Users, color: "bg-green-500" },
    { titleKey: "admin.dashboard.actions.addProgram", href: "/manage/dashboard/programs", icon: Calendar, color: "bg-emerald-500" },
    { titleKey: "admin.dashboard.actions.addBlogPost", href: "/manage/dashboard/blog", icon: BookOpen, color: "bg-teal-500" },
    { titleKey: "admin.dashboard.actions.addTeamMember", href: "/manage/dashboard/team", icon: Shield, color: "bg-lime-500" },
    { titleKey: "admin.dashboard.actions.uploadGallery", href: "/manage/dashboard/gallery", icon: ImageIcon, color: "bg-amber-500" },
    { titleKey: "admin.dashboard.actions.directorMessage", href: "/manage/dashboard/director", icon: MessageSquare, color: "bg-green-600" },
    { titleKey: "admin.dashboard.actions.settings", href: "/manage/dashboard/settings", icon: Settings, color: "bg-green-700" },
  ];
